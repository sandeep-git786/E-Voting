 ...
 * @author sandeep
 */
public class UpdateCandidateControllerServlet2 extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
         RequestDispatcher rd=null;
            try
            {
                ...
                AddCandidateDto candidate=new AddCandidateDto(objValues.get(0),objValues.get(1),objValues.get(2),objValues.get(3),fileContent);
